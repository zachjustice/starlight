    ...
    <body>
        ...
        <nav>
            ...
            <div id="tierone">
                <ul>
                    <li>
                        <a href="products.html#chair">Lights <span class="caret"></span></a>
                        <div>
                            <ul>
                                <li><a href="#">1</a></li>
                                <li><a href="#">2</a></li>
                    ...
                    <li>
                        <a href="products.html#table">Security<span class="caret"></span></a>
                        <div>
                            <ul>
                                <li><a href="#">1</a></li>
                                <li><a href="#">2</a></li>
                    ...
                    <li>
                        <a href="cooker.html">Other<span class="caret"></a>
                        <div>
                            <ul>
                                <li><a href="#">1</a></li>
                                <li><a href="#">2</a></li>
